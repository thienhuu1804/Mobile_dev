...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTextNameFood = (EditText) findViewById(R.id.editTextNameFood);
...
//        });
    ...
    public void viewTxtMessage(){
        foodname = txtTextNameFood.getText().toString();
    ...
    //gửi tin nhắn (cách có kiể tra trạng thái gửi)
//    public void sendSMSMessage() {
//        phoneno = txtPhoneno.getText().toString();
////        final TextView message = findViewById(R.id.textViewMessage);
//        SMS = txtMessage.getText().toString();
//
//
////        txtMessage.addTextChangedListener(new TextWatcher() {
////
////            @Override
////            public void afterTextChanged(SMS editText) {
////                SMS.setText(txtMessage.getText().toString());
////            }
////        });
//
//        Intent intent = new Intent(Intent.ACTION_SENDTO,
